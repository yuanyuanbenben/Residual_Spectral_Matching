...
# baseline compare
loss_total <- foreach(s = 31:40,.verbose=TRUE,.combine = rbind) %dopar% {
...
write.csv(loss_our,"output/case2_nonconvex_loss_our1_4.csv")
loss_baseline1 = data.frame(loss_total[,9:16])
write.csv(loss_baseline1,"output/case2_nonconvex_loss_baseline1_4.csv")
