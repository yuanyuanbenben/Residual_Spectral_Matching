# Compare different condition numbers for convex optimization
...
write.csv(loss_our,paste("output/convex_loss_our1",m,n,rho,r,sigma,kappa,".csv",sep = "_"))
loss_baseline1 = data.frame(loss_total[,5:8])
write.csv(loss_baseline1,paste("output/convex_loss_baseline1",m,n,rho,r,sigma,kappa,".csv",sep = "_"))
