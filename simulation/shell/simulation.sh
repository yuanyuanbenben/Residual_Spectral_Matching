...
echo "m=700 n=350"
# m = 600 n = 300
nohup R --slave --vanilla --args 700 350 20 52 10 10 200 10 < compare_to_baseline.R > test.log 2>&1 &
  echo "waiting..."
wait

echo "m=800 n=400"
# m = 800 n = 400
nohup R --slave --vanilla --args 800 400 20 52 10 10 200 10 < compare_to_baseline.R > test.log 2>&1 &
echo "waiting..."
wait

echo "m=900 n=450"
# m = 800 n = 400
nohup R --slave --vanilla --args 900 450 20 52 10 10 200 10 < compare_to_baseline.R > test.log 2>&1 &
echo "waiting..."
wait

echo "m=1000 n=500"
# m = 800 n = 400
nohup R --slave --vanilla --args 1000 500 20 52 10 10 300 10 < compare_to_baseline.R > test.log 2>&1 &
echo "waiting..."
wait
