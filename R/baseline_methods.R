# Baseline methods for matrix completion:
# 1. Matrix_factor_func: Factorized gradient descent for low-rank matrix completion
# 2. Nuclear_opt_func: Proximal gradient descent for nuclear norm regularized least squares

# ============ Matrix Factorization Method ============
# Matrix_factor_func: Factorized gradient descent for low-rank matrix completion
# Inputs:
...
# ============ Nuclear Norm Optimization Method ============
# Nuclear_opt_func: Proximal gradient descent for nuclear norm regularized least squares
# Inputs:
#   X1, X2: vectors of row and column indices of observed entries
#   Y: vector of observed values
